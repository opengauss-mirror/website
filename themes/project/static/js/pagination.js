...
var Pagination = /** @class */ (function () {
    ...
    Pagination.prototype.render = function () {
        ...
        if (this.options.type <= 1) {
            ...
            this.home.innerText = isZh ? '首页' : 'First';
        ...
        if (this.options.type <= 1) {
            ...
            this.last.innerText = isZh? '尾页' : 'Last';
        ...
        if (this.options.jumper) {
            ...
            count.innerText = (isZh ? '\u5171 ' : 'Total   ') + this.pageNum + (isZh ? ' \u9875' : ' pages');
            jumper.appendChild(count);
            var text_1 = this.createElement('span');
            text_1.innerText = (isZh ? '前往' : 'Go to ');
