...
export default {
  ...
  qa: [
    ...
    },
    {
      ...
      answer: [
        '2025年4月7日前：所有OGCA（初级），OGCP（中级），OGCE（高级）证书，由中国软件行业协会与openGauss社区联合认证，并加盖中国软件协会资质证明公章。',
        '2025年4月7日起：',
        'OGCP（中级），OGCE（高级）：维持中国软件行业协会与openGauss社区联合认证，证书包含中国软件行业协会资质证明公章与社区理事长签名。',
