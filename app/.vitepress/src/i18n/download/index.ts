import { GITEE_LINK, WJX_LINK } from '@/shared/url-config';
export default {
  zh: {
    PAGE_TITLE: `软件包`,
    ...
    PECULIARITY_DETAIL: `openGauss现已正式发行 5.1.0 (Preview) 版本，详细版本特性请参看`,
    WELCOME: `，欢迎下载体验！`,
    RELEASE_LINK: `/zh/docs/5.1.0/docs/ReleaseNotes/Releasenotes.html`,
  ...
  en: {
    ...
    SPECIFICATION_LINK: `${GITEE_LINK}opengauss/release-management/blob/master/openGauss%E7%89%88%E6%9C%AC%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E7%AE%A1%E7%90%86.md`,
    PECULIARITY_DETAIL: `openGauss 5.1.0 (Preview) is now officially available. For details, see `,
    WELCOME: ``,
    RELEASE_LINK: `/en/docs/5.1.0/docs/Releasenotes/Releasenotes.html`,
