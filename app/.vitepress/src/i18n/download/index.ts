...
export default {
  zh: {
    ...
    PECULIARITY_DETAIL: `openGauss现已正式发行 5.0.1 (LTS) 版本，详细版本特性请参看`,
    WELCOME: `，欢迎下载体验！`,
    RELEASE_LINK: `/zh/news/2023-12-20/`,
  ...
  en: {
    ...
    FINANCE:`The installation guide is same as that of the Enterprise-Edition.`,
    ...
    SPECIFICATION_LINK: `${GITEE_LINK}opengauss/release-management/blob/master/openGauss%E7%89%88%E6%9C%AC%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E7%AE%A1%E7%90%86.md`,
    PECULIARITY_DETAIL: `openGauss 5.0.1 (LTS) is now officially available. For details, see `,
    WELCOME: ``,
    RELEASE_LINK: `/zh/news/2023-12-20/`,
