export default {
  zh: {
    cookieTitle: 'openGauss社区重视您的隐私',
    cookieDesc:
      '我们在本网站上使用Cookie，包括第三方Cookie，以便网站正常运行和提升浏览体验。单击“全部接受”即表示您同意这些目的；单击“全部拒绝”即表示您拒绝非必要的Cookie；单击“管理Cookie”以选择接受或拒绝某些Cookie。需要了解更多信息或随时更改您的Cookie首选项，请参阅我们的',
    privacy: '《隐私政策》',
    accept: '全部接受',
    reject: '全部拒绝',
    manage: '管理cookie',
    necessaryTitle: '必要Cookie',
    enabled: '始终启用',
    necessaryDesc:
    ...
    statisticsTitle: '统计分析Cookie',
    statisticsDesc:
      '我们将根据您的同意使用和处理这些非必要Cookie。这些Cookie允许我们获得摘要统计数据，例如，统计访问量和访问者来源，便于我们改进我们的网站。',
    save: '保存设置',
  },
  en: {
    cookieTitle: 'openGauss Community Respects Your Privacy',
    cookieDesc:
