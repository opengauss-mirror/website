    ...
    content: [
      {
        ...
        content: [
          {
            name: 'openGauss_5.0.1 Enterprise-Edition',
            table: 'server',
            size: '125.09MB',
            edition: 'enterprise',
          ...
          {
            name: 'openGauss_5.0.1 Simplified',
            table: 'server',
            size: '93.07MB',
            edition: 'simple',
          ...
          },
          {
            ...
            docsName: 'Finance Installation Guide',
            docs_url:
              '/docs/5.0.0/docs/InstallationGuide/enterprise-edition-installation-process.html',
          },
        ],
