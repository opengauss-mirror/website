...
//         content: [
//           {
//             name: 'openGauss_5.1.0 Enterprise-Edition',---软件包类型
//             size: '120.99MB',---软件包大小
//             edition: '',---软件包hover提示语
    ...
    content: [
      {
        ...
        content: [
          {
            name: 'openGauss_5.1.0 Enterprise-Edition',
            size: '120.99MB',
            edition: '',
          ...
          {
            name: 'openGauss_5.1.0 Simplified',
            size: '89.87MB',
            edition: '',
            down_url: ``,
            sha_code: '',
        ...
        content: [
          {
            ...
            size: '6.29MB',
            down_url: `${OBS_DOWNLOAD_LINK}5.1.0/tools/chameleon-5.1.0-py3-none-any.whl`,
            sha_code:
          ...
          },
          {
            name: 'dbmind_5.1.0',
            size: '153.62MB',
            down_url: `${OBS_DOWNLOAD_LINK}5.1.0/dbmind/arm/dbmind-installer-aarch64-python3.10.sh.tar.gz`,
            sha_code:
          ...
          },
          {
            ...
            size: '701.68MB',
            down_url: `${OBS_DOWNLOAD_LINK}tools/portal/PortalControl-5.1.0.tar.gz`,
            sha_code:
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            name: 'dbmind_5.1.0',
            size: '216.92MB',
            down_url: `${OBS_DOWNLOAD_LINK}5.1.0/dbmind/x86/dbmind-installer-x86_64-python3.10.sh.tar.gz`,
            sha_code:
