        ...
        content: [
          {
            ...
            size: '120.00MB',
            edition: 'enterprise',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-3.1.1-openEuler-64bit-all.tar.gz`,
            sha_code:
          ...
          },
          {
            ...
            size: '88.70MB',
            edition: 'simple',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-3.1.1-openEuler-64bit.tar.bz2`,
            sha_code:
          ...
          },
          {
            ...
            size: '21.10MB',
            edition: 'lite',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-Lite-3.1.1-openEuler-aarch64.tar.gz`,
            sha_code:
        ...
        content: [
          {
            ...
            size: '126.00MB',
            edition: 'enterprise',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-3.1.1-openEuler-64bit-all.tar.gz`,
            sha_code:
          ...
          },
          {
            ...
            size: '94.20MB',
            edition: 'simple',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-3.1.1-openEuler-64bit.tar.bz2`,
            sha_code:
          ...
          },
          {
            ...
            size: '22.00MB',
            edition: 'lite',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-Lite-3.1.1-openEuler-x86_64.tar.gz`,
            sha_code:
        ...
        content: [
          {
            ...
            size: '126.00MB',
            edition: 'enterprise',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-3.1.1-CentOS-64bit-all.tar.gz`,
          ...
          },
          {
            ...
            size: '93.50MB',
            edition: 'simple',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-3.1.1-CentOS-64bit.tar.bz2`,
          ...
          },
          {
            ...
            size: '21.80MB',
            edition: 'lite',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-Lite-3.1.1-CentOS-x86_64.tar.gz`,
            sha_code:
          ...
          },
          {
            ...
            size: '1.20GB',
            edition: 'distributed',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/openGauss-distributed.tar.gz`,
            sha_code:
        ...
        content: [
          {
            name: 'JDBC_3.1.1',
            size: '1.53MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-3.1.1-JDBC.tar.gz`,
          ...
          },
          {
            name: 'ODBC_3.1.1',
            size: '8.30MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-3.1.1-ODBC.tar.gz`,
            sha_code:
          ...
          },
          {
            ...
            size: '2.59MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-3.1.1-openEuler-aarch64-Python.tar.gz`,
            sha_code:
          ...
          },
          {
            name: 'libpq_3.1.1',
            size: '4.50MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-3.1.1-openEuler-64bit-Libpq.tar.gz`,
            sha_code:
        ...
        content: [
          {
            name: 'JDBC_3.1.1',
            size: '1.53MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-3.1.1-JDBC.tar.gz`,
            sha_code:
          ...
          },
          {
            name: 'ODBC_3.1.1',
            size: '8.30MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-3.1.1-ODBC.tar.gz`,
            sha_code:
          ...
          },
          {
            name: 'Python-psycopg2_3.1.1',
            size: '2.90MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-3.1.1-openEuler-x86_64-Python.tar.gz`,
            sha_code:
          ...
          },
          {
            name: 'libpq_3.1.1',
            size: '4.99MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-3.1.1-openEuler-64bit-Libpq.tar.gz`,
            sha_code:
        ...
        content: [
          {
            name: 'JDBC_3.1.1',
            size: '1.53MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-3.1.1-JDBC.tar.gz`,
            sha_code:
          ...
          },
          {
            name: 'ODBC_3.1.1',
            size: '8.90MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-3.1.1-ODBC.tar.gz`,
          ...
          },
          {
            name: 'Python-psycopg2_3.1.1',
            size: '3.12MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-3.1.1-CentOS-x86_64-Python.tar.gz`,
            sha_code:
          ...
          },
          {
            name: 'libpq_3.1.1',
            size: '4.88MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-3.1.1-CentOS-64bit-Libpq.tar.gz`,
            sha_code:
        ...
        content: [
          {
            name: 'symbol_3.1.1',
            size: '382.00MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-3.1.1-openEuler-64bit-symbol.tar.gz`,
            sha_code:
          ...
          },
          {
            ...
            size: '21.90MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/arm/openGauss-3.1.1-openEuler-64bit-cm-symbol.tar.gz`,
        ...
        content: [
          {
            name: 'symbol_3.1.1',
            size: '378.00MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-3.1.1-openEuler-64bit-symbol.tar.gz`,
            sha_code:
          ...
          },
          {
            name: 'cm-symbol_3.1.1',
            size: '20.40MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86_openEuler/openGauss-3.1.1-openEuler-64bit-cm-symbol.tar.gz`,
            sha_code:
        ...
        content: [
          {
            name: 'symbol_3.1.1',
            size: '377.00MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-3.1.1-CentOS-64bit-symbol.tar.gz`,
            sha_code:
          ...
          },
          {
            name: 'cm-symbol_3.1.1',
            size: '20.40MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/x86/openGauss-3.1.1-CentOS-64bit-cm-symbol.tar.gz`,
            sha_code:
        ...
        content: [
          {
            ...
            size: '6.28MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/tools/chameleon-3.1.1-py3-none-any.whl`,
            sha_code:
          ...
          },
          {
            ...
            size: '9.32MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/tools/online-migration-mysql2openGauss-3.1.1.tar.gz`,
            sha_code:
          ...
          },
          {
            ...
            size: '11.80MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/tools/openGauss-reverse-migration-mysql-3.1.1.tar.gz`,
            sha_code:
          ...
          },
          {
            ...
            size: '179.00MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/tools/openGauss-datachecker-performance-3.1.1.tar.gz`,
            sha_code:
        ...
        content: [
          {
            ...
            size: '106.00MB',
            down_url: `${OBS_DOWNLOAD_LINK}3.1.1/tools/DataStudio_win_64.zip`,
            sha_code:
              '8f9ea86295d7a2eceb0e528de832f83eae4936109cea8eb44376a0f4443c83af',
            docsName: 'Documentation',
            docs_url: `${OBS_DOWNLOAD_LINK}3.1.1/tools/Data%20Studio%20%E7%94%A8%E6%88%B7%E6%89%8B%E5%86%8C.pdf`,
          },
        ],
      },
    ],
