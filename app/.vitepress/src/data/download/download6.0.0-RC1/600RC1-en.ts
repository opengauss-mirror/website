        ...
        content: [
          {
            ...
            docsName: '企业版安装指南',
            docs_url:
              '/docs/6.0.0-RC1/docs/InstallationGuide/enterprise-edition-installation-process.html',
          },
          {
            ...
            docsName: '极简版安装指南',
            docs_url:
              '/docs/6.0.0-RC1/docs/InstallationGuide/simplified-installation-process.html',
          },
          {
            ...
            docsName: '轻量版安装指南',
            docs_url:
              '/docs/6.0.0-RC1-lite/docs/InstallationGuide/installation-overview.html',
          },
        ],
      },
      {
