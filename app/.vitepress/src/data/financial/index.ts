import { GITEE_LINK, XINGYEBANK_LINK } from '@/data/url-config'
...
export default {
    zh: {
            ...
            case_list: [
                {
                    ...
                    detailLink: '/userPractice/finance/xingyepaymentsystem/',
                ...
                },
                {
                    ...
                    detailLink: '/userPractice/finance/xingyemanagesystem/',
                    officialLink: `${XINGYEBANK_LINK}/cn/index.html`,
                    type: '金融'
                },
                {
                    ...
                    detailLink: '/userPractice/finance/xingyecollectionsystem/',
                    officialLink: `${XINGYEBANK_LINK}/cn/index.html`,
                    type: '金融'
                },
        ...
        interaction: {
            ...
            jumpLink: `${GITEE_LINK}/opengauss/open-gauss-finance`,
        },
        download: {
            title: '版本下载',
