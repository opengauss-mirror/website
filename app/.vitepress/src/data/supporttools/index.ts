    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: `HAProxy`,
          desc: `数据库读写负载均衡`,
          address: `${GITHUB_LINK}/haproxy/haproxy`,
        ...
        },
        {
          ...
          name: `vip-manager`,
          desc: `自动IP故障转移`,
          address: `${GITHUB_LINK}/cybertec-postgresql/vip-manager`,
          guide: `${GITHUB_LINK}/cybertec-postgresql/vip-manager#Configuration`,
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          name: `Kubernetes`,
          desc: `一个开源的容器集群管理平台`,
          address: `${GITHUB_LINK}/kubernetes/kubernetes`,
        ...
        },
        {
          ...
          address: `${GITHUB_LINK}/zalando/patroni`,
      ...
      children: [
        {
          ...
          address: `${GITHUB_LINK}/tig100/JdbcPgBackup`,
        },
        {
          iden: `dataTools`,
          name: `Database-Sync`,
          desc: `基于Java开发，功能强大、配置灵活的数据库之间同步工具`,
          address: `${GITHUB_LINK}/GongDexing/database-sync`,
        },
        {
          iden: `dataTools`,
          name: `Debezium`,
      ...
      children: [
        {
          ...
          address: `${GITHUB_LINK}/zabbix/zabbix`,
        ...
        },
        {
          ...
          address: `${GITHUB_LINK}/prometheus/prometheus`,
