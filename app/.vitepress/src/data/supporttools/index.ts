      ...
      children: [
        {
          ...
          address: `${GITEE_LINK}opengaussorg/dashboard/projects/opengauss/openGauss-connector-python-psycopg2/`,
          guide: `${PSY_LINK}docs/`,
        },
        {
          iden: `connectors`,
          ...
          address: `${GITEE_LINK}opengauss/openGauss-connector-python-pyog`,
        ...
        },
        {
          ...
          address: `${E_LINK}opengaussorg/repos/opengauss/openGauss-connector-go-pq`,
          guide: `${GITEE_LINK}opengauss/openGauss-connector-go-pq/blob/master/README.cn.md`,
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          address: `${GITEE_LINK}opengauss/openGauss-tools-ora2og`,
          guide: `${GITEE_LINK}opengauss/openGauss-tools-ora2og/blob/master/README.md`,
        },
        {
          iden: `migrationTools`,
          name: `pg_chameleon`,
          desc: `MySQL到openGauss数据迁移工具`,
          address: `${GITEE_LINK}opengauss/openGauss-tools-chameleon`,
          guide: `${GITEE_LINK}opengauss/openGauss-tools-chameleon/blob/master/chameleon%E4%BD%BF%E7%94%A8%E6%8C%87%E5%8D%97.md`,
        },
        {
          iden: `migrationTools`,
          name: `pgloader`,
          desc: `一个数据导入工具，使用COPY命令将数据导入到openGauss`,
          address: `${GITEE_LINK}opengauss/openGauss-tools-loader`,
          guide: `${GITEE_LINK}opengauss/openGauss-tools-loader/blob/master/pgloader%E4%BD%BF%E7%94%A8%E6%8C%87%E5%8D%97.pdf`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          address: `${GITEE_LINK}opengauss/DataStudio`,
      ...
      children: [
        {
          ...
          address: `${GITEE_LINK}opengauss/Yukon`,
          guide: `${YUKON_LINK}`,
        },
      ],
    },
