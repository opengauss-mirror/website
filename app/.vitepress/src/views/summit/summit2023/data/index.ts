...
import { SHIMO_LINK } from '@/data/url-config';
  ...
  collects: [
    {
      ...
      link: `${SHIMO_LINK}/forms/0oYbBcXZoEkADafV/fill`,
    },
    {
      title: ['演讲发言人', '征集'],
      titleEN: ['CALL FOR', 'SPEAKER'],
      link: `${SHIMO_LINK}/forms/AtU818fux10g43pb/fill`,
    },
    {
      title: ['DEMO', '征集'],
      titleEN: ['CALL FOR', 'DEMO'],
      link: `${SHIMO_LINK}/forms/1AKIZ5GlFNaH31sY/fill`,
    },
  ],
  previous: {
    title: '精彩回顾',
