...
<template>
  <AppContent>
    <BreadCrumbs :bread1="i18n.connect.VIDEO_TITLE" :bread2="chapterInfo.name" :link1="`/${lang}/video/`" />
    <div class="page-tile">
    ...
    <div class="video-content">
      ...
      <div class="video-detail">
        ...
        <div class="video-main">
          <video v-if="currentNode.video" :src="currentNode.video" :poster="chapterInfo.poster" autoplay controls style="width: 100%"></video>
        </div>
      </div>
    </div>
  </AppContent>
