            ...
            <div v-if="subitem.centos_url !== ''">
              ...
              <div class="down-action">
                <OButton
                  ...
                  animation
                  type="primary"
                  @click="handleDownloadUrl(subitem.centos_url)"
                >
              ...
              <div v-if="subitem.download_guide_url" class="download-guide-btn">
                <OButton
                  size="mini"
                  animation
                  @click="handleDownloadUrl(subitem.download_guide_url)"
                >
            ...
            <div v-if="subitem.aarch_url !== ''">
              ...
              <div class="down-action">
                <OButton
                  ...
                  type="primary"
                  animation
                  @click="handleDownloadUrl(subitem.aarch_url)"
                >
                  {{ i18n.download.BTN_TEXT }}
                  <template #suffixIcon>
                    <IconDownload />
            ...
            <div v-if="subitem.x86_url !== ''">
              ...
              <div class="down-action">
                <OButton
                  ...
                  type="primary"
                  animation
                  @click="handleDownloadUrl(subitem.x86_url)"
                >
                  {{ i18n.download.BTN_TEXT }}
                  <template #suffixIcon>
                    <IconDownload />
          ...
          <template #default="scope">
            <div v-if="scope.row.centos_url !== ''" class="down-action">
              <OButton
                ...
                animation
                type="primary"
                @click="handleDownloadUrl(scope.row.centos_url)"
              >
                {{ i18n.download.BTN_TEXT }}
                <template #suffixIcon>
                  <IconDownload />
            ...
            <div v-if="scope.row.download_guide_url" class="download-guide-btn">
              <OButton
                size="mini"
                animation
                @click="handleDownloadUrl(scope.row.download_guide_url)"
              >
                {{ i18n.download.DOCS_TEXT }}
                <template #suffixIcon>
                  <IconDownload />
          ...
          <template #default="scope">
            <div v-if="scope.row.aarch_url !== ''" class="down-action">
              <OButton
                ...
                type="primary"
                animation
                @click="handleDownloadUrl(scope.row.aarch_url)"
              >
                {{ i18n.download.BTN_TEXT }}
                <template #suffixIcon>
                  <IconDownload />
          ...
          <template #default="scope">
            <div v-if="scope.row.x86_url !== ''" class="down-action">
              <OButton
                ...
                type="primary"
                animation
                @click="handleDownloadUrl(scope.row.x86_url)"
              >
                {{ i18n.download.BTN_TEXT }}
                <template #suffixIcon>
                  <IconDownload />
