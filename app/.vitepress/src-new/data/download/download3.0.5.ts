    ...
    zh: [
      {
        ...
        centos_sha:
          'f5af58c22a55a49ce5b1c07c74f167f142b79e030f6e31c466ec549a981e112e',
        aarch_url: `${OBS_DOWNLOAD_LINK}3.0.5/arm/openGauss-3.0.5-openEuler-64bit-all.tar.gz`,
        aarch_sha:
          'd6766d070b0b721f65a93d90a77182ae73af4600057c5cced670767c804449d5',
        x86_url: `${OBS_DOWNLOAD_LINK}3.0.5/x86_openEuler/openGauss-3.0.5-openEuler-64bit-all.tar.gz`,
        x86_sha:
          '276b25a2b09b94c38c2fd4933842654fb410041a6e4c0e21eab3b33d0cb86394',
      },
      {
        ...
        centos_sha:
          'c513e8ec0c3cf280a5c99fea3ed0bbeb31da51b7b25044a1f6e6de3c30a6a716',
        aarch_url: `${OBS_DOWNLOAD_LINK}3.0.5/arm/openGauss-3.0.5-openEuler-64bit.tar.bz2`,
        aarch_sha:
          'da794dcc02abc73bd234a6d4cc5306962296da1220e7aeebc1242586a7e70ead',
        x86_url: `${OBS_DOWNLOAD_LINK}3.0.5/x86_openEuler/openGauss-3.0.5-openEuler-64bit.tar.bz2`,
        x86_sha:
          'bf54d659de44ad2f3a2be79f90e532b7d19b48f7d4bbbca12c65505a8e2c04bc',
      },
      {
        ...
        centos_sha:
          'e9078e1a79d0a92ccd5bba55ea130b18192d55bd506429c7f21a36044782fedf',
        aarch_url: `${OBS_DOWNLOAD_LINK}3.0.5/arm/openGauss-Lite-3.0.5-openEuler-aarch64.tar.gz`,
        aarch_sha:
          '7750817d464134370cbb3cfb16974a7dd4ff1f1eda9144f7214f223af9016c54',
        x86_url: `${OBS_DOWNLOAD_LINK}3.0.5/x86_openEuler/openGauss-Lite-3.0.5-openEuler-x86_64.tar.gz`,
        x86_sha:
          'e2bc83ded3471f72871211395e66425a98049652ecd54d375ee12955a6f44b6e',
      },
    ],
    en: [
      {
    ...
    zh: [
      {
        ...
        centos_sha:
          '7b96b3d7e16fce2407e3f8a1f6e373641bc230646c19c71fa428b7e8b8663acd',
        aarch_url: `${OBS_DOWNLOAD_LINK}3.0.5/arm/openGauss-3.0.5-openEuler-64bit-symbol.tar.gz`,
        aarch_sha:
          'c9695110a247592bb47d4e01c8601ba087b3ef77c8029406746abd3024018bb3',
        x86_url: `${OBS_DOWNLOAD_LINK}3.0.5/x86_openEuler/openGauss-3.0.5-openEuler-64bit-symbol.tar.gz`,
        x86_sha:
          '8bd24a5587a569574d5223596a721b3cf1d1e1e1a53f1db608f43867a61468d1',
      },
    ],
    en: [
      {
