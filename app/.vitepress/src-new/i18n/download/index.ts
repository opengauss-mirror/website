...
export default {
  zh: {
    ...
    DOWNLOAD_TIPS: `登录提示`,
    DOWNLOAD_TEXT: `您尚未登录，请您登录或注册后继续下载最新版软件`,
    DOWNLOAD_COMFIRM: `确定`,
    DOWNLOAD_CANCEL: `取消`,
    ...
    SPECIFICATION_LINK: `${ATOMGIT_LINK}/opengauss/release-management/blob/master/openGauss%E7%89%88%E6%9C%AC%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E7%AE%A1%E7%90%86.md`,
    ...
    ARCHITECTURE: `架构`,
    OS: `操作系统`,
    TABLE_HEAD: [`软件包类型`, `软件包大小`, `软件包下载`, `完整性校验`, `说明文档`, '软件包名称', '功能描述'],
  ...
  en: {
    ...
    DOWNLOAD_TIPS: `NOTICE`,
    DOWNLOAD_TEXT: `Please Login or Register to download the latest version.`,
    DOWNLOAD_COMFIRM: `OK`,
