...
1) 当您注册或登录论坛服务时，我们会从openGauss账号收集您的**用户名**、**邮箱**、**手机号**、**密码**、昵称、头像、Gitee ID、GitCode ID，为您的账户赋予权限和角色；同时我们还会收集您的**IP地址**、**地域**、设备信息、登录时间、**偏好设置**，以便为您提供更安全的服务；
...
**c) 我们可能会将您的个人信息向我们的运营方（华为技术有限公司及其关联公司）共享，以供它们为您提供服务支持或安全支持**。
