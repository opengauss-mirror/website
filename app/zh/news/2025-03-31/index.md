...
发行说明请参考官网： [https://docs.opengauss.org/zh/docs/7.0.0-RC1/docs/ReleaseNotes/Releasenotes.html](https://docs.opengauss.org/zh/docs/7.0.0-RC1/docs/ReleaseNotes/Releasenotes.html)
...
- openEuler 24.03 SP1版本默认集成openGauss 6.0.0（LTS）企业版，可通过yum install一键安装openGauss企业版（不包含MOT，OBS和codegen功能，以及OM、CM外部组件）
...
openGauss 持续以用户真实需求为动力，致力于产品竞争力提升。我们特别感谢每一位用户对 openGauss 的支持，openGauss 7.0.0-RC1 作为下一个长周期版本的先行体验版，也期待聆听每一位用户的反馈意见。
