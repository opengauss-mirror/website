...
- SIG的核心成员主导SIG的治理。请查看[SIG的角色说明](https://gitee.com/openGauss/community/blob/master/community-membership_cn.md)。您可以在贡献的同时积累经验和提升影响力。
...
- **方式一**：如果您不了解有哪些SIG或项目，您可以查看[SIG列表](https://openGauss.org/zh/sig.html)，它包含当前openGauss社区成立的所有SIG团队的清单。您可以通过该列表快速的定位到您感兴趣的领域所对应SIG团队。同时还会您提供该SIG团队的如下信息：
...
#### 安装openGauss <a name="安装openGauss"></a>
...
如果您想参与编码贡献，需要准备openGauss的开发环境，请参考[开发环境准备](https://gitee.com/openGauss/community/blob/master/zh/contributors/prepare-environment.md)。



#### 下载和构建软件包 <a name="下载和编译软件包"></a>

如果您想下载、修改、构建及验证openGauss提供的软件包，请参考[构建软件包](https://gitee.com/openGauss/community/blob/master/zh/contributors/package-install.md)。
...
在本地分支上完成修改后，进行构建和本地验证，请参考[构建软件包](https://gitee.com/openGauss/community/blob/master/zh/contributors/package-install.md)。
...
openGauss是一个开放的社区，我们希望所有参与社区的人都能成为活跃的检视者。可以参考[社区成员](https://gitee.com/openGauss/community/blob/master/community-membership_cn.md)，该文档描述了不同贡献者的角色职责。
...
注意：如果您的PR请求没有引起足够的关注，可以在SIG的邮件列表或dev@openGauss.org求助。
...
您也可以参与社区组件打包，请参考[如何打包](https://gitee.com/openGauss/community/blob/master/zh/contributors/packaging.md)。
...
+ [安全处理流程](https://gitee.com/openGauss/community/blob/master/zh/security-committee/security-process.md)——简要描述了处理安全问题的过程。
+ [安全披露信息](https://gitee.com/openGauss/community/blob/master/zh/security-committee/security-disclosure.md)——如果您希望报告安全漏洞，请参考此页面。
...
openGauss社区的交流方式有邮件列表、IRC会议和视频会议等，使用方式请参考[社区交流方式指导](https://gitee.com/openGauss/community/tree/master/zh/communication)。
...
社区每年会定期举办开发者大会，您可以通过[https://openGauss.org](https://openGauss.org)上的信息或通过电子邮件<dev@openGauss.org>与我们联系。来加入我们把~
