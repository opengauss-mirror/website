...
- openGauss社区资料：
  ...
  https://opengauss.org/zh/docs/latest/docs/Quickstart/Quickstart.html
...
| -------- | --------------------------------------------------- |
| a        | 每提交一个Issue积**2分**。                          |
| b        | 提交第一个PR积**15分**，后续每提交一个PR积**5分**。 |
| c        | Watching和Starred docs仓库积**5分**。               |

**2.** 有效的Issue或PR的评定：

​      a. Issue或PR已添加“**openGauss资料捉虫活动**”标签。

​	  b. 活动主办方回复为“**恭喜您！此Issue有效，感谢您的反馈**”或**PR经审核后合入到社区**表示该Issue或PR有效。
...
| 奖项   | 奖品明细                                                     |
| ------ | ------------------------------------------------------------ |
| 一等奖 | ikbc经典系列机械键盘/HUAWEI FreeBuds 4i无线耳机/京东购物卡500元 |
| 二等奖 | 华为手环4/HUAWEI 背包/华为智能体脂秤/京东购物卡200元         |
| 三等奖 | 华为三脚架自拍杆 无线版/华为耳机/京东购物卡100元             |
| 四等奖 | Gauss松鼠会定制保温杯/Gauss松鼠会文化衫/京东购物卡50元       |
...
<img src="./pride2.png" width="50%" style="margin-bottom: 0.2rem;" />
...
<img src="./pride3.png" width="50%" style="margin-bottom: 0.2rem;" />
